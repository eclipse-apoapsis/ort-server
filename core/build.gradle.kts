...
dependencies {
    ...
    implementation(projects.components.dependencyGraph.dependencyGraphBackend)
    implementation(projects.components.dependencyGraph.dependencyGraphBackend) {
        capabilities {
            requireCapability("$group:routes:$version")
        }
    ...
    implementation(projects.components.serverSettings.serverSettingsBackend) {
        capabilities {
            requireCapability("$group:routes:$version")
        }
    }
...
tinyJib {
    ...
    to.image = System.getProperty("jib.to.image")
        ?: "${dockerImagePrefix}ort-server-core:$dockerImageTag"
