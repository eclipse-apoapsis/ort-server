...
abstract class AbstractAuthorizationTest(body: AbstractAuthorizationTest.() -> Unit) : AbstractIntegrationTest({}) {
    ...
    override protected val additionalConfig = keycloakConfig + jwtConfig + secretsConfig
