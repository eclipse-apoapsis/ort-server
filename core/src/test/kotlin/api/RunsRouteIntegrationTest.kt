    ...
    "GET /runs/{runId}/statistics" should {
        ...
        "return null for the count if the corresponding job is skipped or has not finished yet" {
            integrationTestApplication {
                ...
                with(statistics) {
                    issuesCount.shouldBeNull()
                    issuesCountBySeverity.shouldBeNull()
                    packagesCount.shouldBeNull()
                    ecosystems.shouldBeNull()
                    vulnerabilitiesCount.shouldBeNull()
                    vulnerabilitiesCountByRating.shouldBeNull()
                    ruleViolationsCount.shouldBeNull()
                    ruleViolationsCountBySeverity.shouldBeNull()
                }
            }
        }
