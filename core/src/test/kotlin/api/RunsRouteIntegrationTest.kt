    ...
    "GET /runs/{runId}/rule-violations" should {
        ...
        "return a paginated and properly sorted list of rule violations for given runId" {
            integrationTestApplication {
                ...
                val ruleViolationsResponse = response.body<PagedResponse<RuleViolationWithIdentifier>>()
                ...
                ruleViolationsResponse.data[0] shouldBe ruleViolations[2].mapToApiRuleViolationWithIdentifier()
                ruleViolationsResponse.data[1] shouldBe ruleViolations[3].mapToApiRuleViolationWithIdentifier()
                ruleViolationsResponse.data[2] shouldBe ruleViolations[1].mapToApiRuleViolationWithIdentifier()
                ruleViolationsResponse.data[3] shouldBe ruleViolations[0].mapToApiRuleViolationWithIdentifier()
            }
        }
    }
})
