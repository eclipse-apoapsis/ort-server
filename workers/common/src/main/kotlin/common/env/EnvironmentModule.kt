...
import org.eclipse.apoapsis.ortserver.dao.repositories.infrastructureservice.DaoDynamicInfrastructureServiceRepository
...
fun buildEnvironmentModule(): Module = module {
    ...
    single<DynamicInfrastructureServiceRepository> { DaoDynamicInfrastructureServiceRepository(get()) }
