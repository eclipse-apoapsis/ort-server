 ...
 * invalid.
 */
internal fun ResolvedInfrastructureService.urlWithCredentials(builder: ConfigFileBuilder, targetFile: String): String? =
    runCatching {
        ...
        GeneratorLogger.error("Invalid URL for service '$this'. Ignoring it.", targetFile, it)
    }.getOrNull()
