...
class MavenSettingsGenerator : EnvironmentConfigGenerator<MavenDefinition> {
    companion object {
        ...
        private const val MAVEN_SETTINGS_PATH = ".m2/settings.xml"

        /** The attributes of the `settings` root element. */
        private const val ROOT_ATTRIBUTES = "xmlns=\"http://maven.apache.org/SETTINGS/1.1.0\" " +
