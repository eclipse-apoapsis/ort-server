...
# This is a common base image for all ORT Server worker images. It provides some base functionality like setting
# file permissions for the user, setting up certificates, etc. And, it defines the temurin base image.
