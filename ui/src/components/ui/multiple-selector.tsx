  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'border-input ring-offset-background focus-within:ring-ring dark:bg-input/30 min-h-10 rounded-md border text-base focus-within:ring-2 focus-within:ring-offset-2 md:text-sm',
            {
              ...
              return (
                <Badge
                  ...
                  className={cn(
                    ...
                    'data-[fixed]:text-muted data-[fixed]:hover:bg-muted-foreground data-[fixed]:bg-muted-foreground',
                    badgeClassName
                  )}
