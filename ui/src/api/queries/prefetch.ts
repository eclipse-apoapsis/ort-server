 ...
 * @throws ApiError
 */
export const prefetchUseHealthServiceGetLiveness = (queryClient: QueryClient) =>
  queryClient.prefetchQuery({
    queryKey: [Common.useHealthServiceGetLivenessKey, []],
 ...
 * @throws ApiError
 */
export const prefetchUseReportsServiceGetReportByRunIdAndToken = (
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useReportsServiceGetReportByRunIdAndTokenKey,
      [{ runId, token }],
    ],
    queryFn: () => ReportsService.getReportByRunIdAndToken({ runId, token }),
  });
/**
 ...
 * @throws ApiError
 */
export const prefetchUseReportsServiceGetReportByRunIdAndFileName = (
  queryClient: QueryClient,
  {
    fileName,
    runId,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useReportsServiceGetReportByRunIdAndFileNameKey,
      [{ fileName, runId }],
    ],
    queryFn: () =>
      ReportsService.getReportByRunIdAndFileName({ fileName, runId }),
  });
/**
 ...
 * @throws ApiError
 */
export const prefetchUseOrganizationsServiceGetOrganizations = (
  queryClient: QueryClient,
  {
    limit,
    offset,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useOrganizationsServiceGetOrganizationsKey,
      [{ limit, offset, sort }],
    ],
    queryFn: () =>
      OrganizationsService.getOrganizations({ limit, offset, sort }),
  });
/**
 ...
 * @throws ApiError
 */
export const prefetchUseOrganizationsServiceGetOrganizationById = (
  queryClient: QueryClient,
  {
    organizationId,
  }: {
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useOrganizationsServiceGetOrganizationByIdKey,
      [{ organizationId }],
    ],
 ...
 * @throws ApiError
 */
export const prefetchUseProductsServiceGetOrganizationProducts = (
  queryClient: QueryClient,
  {
    limit,
    offset,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useProductsServiceGetOrganizationProductsKey,
 ...
 * @throws ApiError
 */
export const prefetchUseProductsServiceGetProductById = (
  queryClient: QueryClient,
  {
    productId,
  }: {
  ...
  queryClient.prefetchQuery({
    queryKey: [Common.useProductsServiceGetProductByIdKey, [{ productId }]],
 ...
 * @throws ApiError
 */
export const prefetchUseSecretsServiceGetSecretsByOrganizationId = (
  queryClient: QueryClient,
  {
    limit,
    offset,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useSecretsServiceGetSecretsByOrganizationIdKey,
      [{ limit, offset, organizationId, sort }],
    ],
    queryFn: () =>
 ...
 * @throws ApiError
 */
export const prefetchUseSecretsServiceGetSecretByOrganizationIdAndName = (
  queryClient: QueryClient,
  {
    organizationId,
    secretName,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useSecretsServiceGetSecretByOrganizationIdAndNameKey,
 ...
 * @throws ApiError
 */
export const prefetchUseSecretsServiceGetSecretsByProductId = (
  queryClient: QueryClient,
  {
    limit,
    offset,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useSecretsServiceGetSecretsByProductIdKey,
      [{ limit, offset, productId, sort }],
    ],
    queryFn: () =>
      SecretsService.getSecretsByProductId({ limit, offset, productId, sort }),
  });
/**
 ...
 * @throws ApiError
 */
export const prefetchUseSecretsServiceGetSecretByProductIdAndName = (
  queryClient: QueryClient,
  {
    productId,
    secretName,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useSecretsServiceGetSecretByProductIdAndNameKey,
      [{ productId, secretName }],
    ],
    queryFn: () =>
      SecretsService.getSecretByProductIdAndName({ productId, secretName }),
  });
/**
 ...
 * @throws ApiError
 */
export const prefetchUseSecretsServiceGetSecretsByRepositoryId = (
  queryClient: QueryClient,
  {
    limit,
    offset,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useSecretsServiceGetSecretsByRepositoryIdKey,
 ...
 * @throws ApiError
 */
export const prefetchUseSecretsServiceGetSecretByRepositoryIdAndName = (
  queryClient: QueryClient,
  {
    repositoryId,
    secretName,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useSecretsServiceGetSecretByRepositoryIdAndNameKey,
 ...
 * @throws ApiError
 */
export const prefetchUseInfrastructureServicesServiceGetInfrastructureServicesByOrganizationId =
  (
    queryClient: QueryClient,
    {
      limit,
    ...
    queryClient.prefetchQuery({
      queryKey: [
        Common.useInfrastructureServicesServiceGetInfrastructureServicesByOrganizationIdKey,
        [{ limit, offset, organizationId, sort }],
      ],
      queryFn: () =>
 ...
 * @throws ApiError
 */
export const prefetchUseRepositoriesServiceGetRepositoriesByProductId = (
  queryClient: QueryClient,
  {
    limit,
    offset,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useRepositoriesServiceGetRepositoriesByProductIdKey,
      [{ limit, offset, productId, sort }],
    ],
    queryFn: () =>
 ...
 * @throws ApiError
 */
export const prefetchUseRepositoriesServiceGetRepositoryById = (
  queryClient: QueryClient,
  {
    repositoryId,
  }: {
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useRepositoriesServiceGetRepositoryByIdKey,
      [{ repositoryId }],
    ],
    queryFn: () => RepositoriesService.getRepositoryById({ repositoryId }),
  });
/**
 ...
 * @throws ApiError
 */
export const prefetchUseRepositoriesServiceGetOrtRuns = (
  queryClient: QueryClient,
  {
    limit,
    offset,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useRepositoriesServiceGetOrtRunsKey,
      [{ limit, offset, repositoryId, sort }],
    ],
    queryFn: () =>
      RepositoriesService.getOrtRuns({ limit, offset, repositoryId, sort }),
  });
/**
 ...
 * @throws ApiError
 */
export const prefetchUseRepositoriesServiceGetOrtRunByIndex = (
  queryClient: QueryClient,
  {
    ortRunIndex,
    repositoryId,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useRepositoriesServiceGetOrtRunByIndexKey,
      [{ ortRunIndex, repositoryId }],
    ],
    queryFn: () =>
      RepositoriesService.getOrtRunByIndex({ ortRunIndex, repositoryId }),
  });
/**
 ...
 * @throws ApiError
 */
export const prefetchUseLogsServiceGetLogsByRunId = (
  queryClient: QueryClient,
  {
    level,
    runId,
  ...
  queryClient.prefetchQuery({
    queryKey: [
      Common.useLogsServiceGetLogsByRunIdKey,
      [{ level, runId, steps }],
    ],
    queryFn: () => LogsService.getLogsByRunId({ level, runId, steps }),
  });
