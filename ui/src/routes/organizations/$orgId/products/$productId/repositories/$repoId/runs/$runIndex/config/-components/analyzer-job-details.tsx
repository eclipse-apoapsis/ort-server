    ...
    <div className='ml-4 flex flex-col gap-4 text-sm'>
      ...
      {jobConfigs.environmentConfig?.environmentVariables && (
        <div>
          ...
          {jobConfigs.environmentConfig.environmentVariables.map((env) => (
            <div
            ...
            <div className='ml-2' key={pm}>
              ...
              <div className='ml-2'>
                <RenderProperty
                  ...
                  value={jobConfigs.packageManagerOptions?.[pm]?.mustRunAfter}
                  showIfEmpty={false}
                />
                <RenderProperty
                  label='Options'
      ...
      {jobConfigs.packageCurationProviders && (
        <div className='space-y-2'>
          <Label className='font-semibold'>Package curation providers</Label>
