    ...
    cell: ({ row }) => (
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent>
            Show the details of the rule violation
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
    ),
  ...
  return (
    <Card className='h-fit'>
      <CardHeader>
        ...
        <CardDescription>
          These are the rule violations found currently in the project. Please
          note that the status may change over time, as your project
          dependencies change. Therefore, your project should be scanned for
          rule violations regularly.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <CardContent>
