...
open class UnauthorizedException(message: String, cause: Throwable? = null) : OrtServerException(message, cause)

/** Exception thrown when access to a resource is forbidden. */
open class ForbiddenException(message: String, cause: Throwable? = null) : OrtServerException(message, cause)
...
open class InternalServerException(message: String, cause: Throwable? = null) : OrtServerException(message, cause)
