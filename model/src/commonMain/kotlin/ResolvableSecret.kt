 ...
 */
object ResolvableSecretSerializer : KSerializer<ResolvableSecret> {
    private val delegate = ResolvableSecret.generatedSerializer()
    ...
    override fun serialize(encoder: Encoder, value: ResolvableSecret) {
