...
Then build the base images for the workers which contain the external tools and required configuration plus the image for the UI either via the Gradle task
