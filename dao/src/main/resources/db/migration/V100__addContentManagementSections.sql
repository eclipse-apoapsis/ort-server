...
The "company" layout marker is aligned to the left of the footer.
...
An arbitrary number of "column" layout markers are aligned to the right of the footer.

:::column
[Docs](https://eclipse-apoapsis.github.io/ort-server/docs/intro)
:::
