 ...
 */
object RepositoryConfigurationsPathExcludes : Table("repository_configurations_path_excludes") {
    ...
    override val primaryKey: PrimaryKey
        get() = PrimaryKey(repositoryConfigurationId, pathExcludeId, name = "${tableName}_pkey")
}
