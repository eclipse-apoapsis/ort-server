...
internal fun Route.getRunDetectedLicenseFindings(
    ...
    get("runs/{runId}/detected-licenses/{license}/packages/{identifier}/findings", {
        ...
        response {
            HttpStatusCode.OK to {
                description = "Success."
                jsonBody<PagedResponse<LicenseFinding>> {
                    example("Get detected license findings") {
                        value = PagedResponse(
                            data = listOf(LicenseFinding("LICENSE", 1, 10, 99f, "ScanCode 32.0.0")),
