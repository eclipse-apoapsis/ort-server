...
fun Route.licenseFindingRoutes(service: LicenseFindingService, checker: AuthorizationChecker) {
    route("license-findings") {
        getRunDetectedLicenses(service, checker)
        getRunDetectedLicenseFindings(service, checker)
        getRunPackagesWithDetectedLicense(service, checker)
    }
}
