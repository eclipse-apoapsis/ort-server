    ...
    get("/search/package", {
        ...
        request {
            queryParameter<String?>("identifier") {
                description = "The package identifier to search for (ORT format: type:namespace:name:version). " +
                    "Supports RegEx. Mutually exclusive with 'purl'."
            }
            queryParameter<String?>("purl") {
                description = "The package URL to search for. Searches against effective (post-curation) PURLs. " +
                    "Supports RegEx. Mutually exclusive with 'identifier'."
            }
        ...
        // Validate that exactly one of identifier or purl is provided
        val hasIdentifier = identifierParam != null
        val hasPurl = purlParam != null
        if (hasIdentifier == hasPurl) {
