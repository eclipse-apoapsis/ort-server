...
internal fun Route.getProductInfrastructureServices(
    infrastructureServiceService: InfrastructureServiceService
) = get("/products/{productId}/infrastructure-services", {
    operationId = "getProductInfrastructureServices"
    summary = "List all infrastructure services of a product"
    ...
    response {
        HttpStatusCode.OK to {
            ...
            jsonBody<PagedResponse<InfrastructureService>> {
                example("List all infrastructure services for a product") {
                    value = PagedResponse(
                        listOf(
    ...
    val infrastructureServicesForProduct =
        infrastructureServiceService.listForId(ProductId(prodId), pagingOptions.mapToModel())

    val pagedResponse = infrastructureServicesForProduct.mapToApi(ModelInfrastructureService::mapToApi)
