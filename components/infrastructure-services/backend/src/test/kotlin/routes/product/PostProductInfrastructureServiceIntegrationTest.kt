...
class PostProductInfrastructureServiceIntegrationTest : InfrastructureServicesIntegrationTest({
    "PostProductInfrastructureService" should {
        "create an infrastructure service" {
            infrastructureServicesTestApplication { client ->
                ...
                val response = client.post("/products/$prodId/infrastructure-services") {
        ...
        "respond with 'Conflict' if service with same name and prodId already exists" {
            infrastructureServicesTestApplication { client ->
                install(StatusPages) {
                    // TODO: This should use the same config as in core.
