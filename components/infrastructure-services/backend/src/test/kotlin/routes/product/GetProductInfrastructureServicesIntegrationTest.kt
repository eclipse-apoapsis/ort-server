...
class GetProductInfrastructureServicesIntegrationTest : InfrastructureServicesIntegrationTest({
    "GetProductInfrastructureServices" should {
        "list existing infrastructure services" {
            infrastructureServicesTestApplication { client ->
                ...
                val response = client.get("/products/$prodId/infrastructure-services")
        ...
        "support query parameters" {
            infrastructureServicesTestApplication { client ->
                ...
                val response = client.get("/products/$prodId/infrastructure-services?sort=name&limit=4")
