    ...
    "GetSecretsByOrganizationId" should {
        "return all secrets for this organization" {
            integrationTestApplication { client ->
                // TODO: Make this less redundant like for the auth tests.
                application {
                    routing {
                        authenticate("test") {
                ...
                val organizationId = dbExtension.fixtures.createOrganization().id

                val secret1 = secretRepository.create("path1", "name1", "description1", OrganizationId(organizationId))
                val secret2 = secretRepository.create("path2", "name2", "description2", OrganizationId(organizationId))
        ...
        "support query parameters" {
            integrationTestApplication {
                ...
                secretRepository.create("path1", "name1", "description1", OrganizationId(organizationId))
                val secret = secretRepository.create("path2", "name2", "description2", OrganizationId(organizationId))
