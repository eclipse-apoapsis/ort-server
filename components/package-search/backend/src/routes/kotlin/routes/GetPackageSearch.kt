...
@Suppress("LongMethod")
internal fun Route.getPackageSearch(packageSearchService: PackageSearchService) =
    get("/search/packages", {
        ...
        response {
            HttpStatusCode.OK to {
                description = "Success"
                jsonBody<List<PackageSearchDto>> {
        ...
        val ortRuns = packageSearchService.search(
