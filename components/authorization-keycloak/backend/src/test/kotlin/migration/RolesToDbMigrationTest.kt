...
class RolesToDbMigrationTest : StringSpec() {
    private val dbExtension = extension(DatabaseTestExtension())

    /**
     * Create a test instance of [RolesToDbMigration] with the given dependencies.
     */
    ...
    init {
        "role assignments for all hierarchy elements should be migrated correctly" {
            ...
            val authorizationService = createMigration(
                keycloakClient = keycloakClient,
                authorizationService = dbAuthorizationService
            )
 ...
 * [assignments] list.
 */
private fun createDbAuthorizationServiceMock(assignments: MutableList<RoleAssignment>): AuthorizationService =
