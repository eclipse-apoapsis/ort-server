...
/**
 * Factory implementation for [LocalConfigFileProvider].
 */
class LocalConfigFileProviderFactory : ConfigFileProviderFactory {
    companion object {
        /** The name of this provider implementation. */
        const val NAME = "local-config"
    }

    override val name: String = NAME

    override fun createProvider(config: Config, secretProvider: ConfigSecretProvider): ConfigFileProvider =
        LocalConfigFileProvider.create(config)
}
